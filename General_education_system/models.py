...
class Colledge(models.Model):
    name_university = models.CharField(max_length=100, verbose_name='Название колледжа')
    address_university = models.CharField(max_length=100, verbose_name='Адрес колледжа')
    date_of_foundation = models.DateTimeField(auto_now_add=True, verbose_name='Дата основания')
    filial_of_university = models.CharField(max_length=100, verbose_name='Филиал колледжа', blank=True)
